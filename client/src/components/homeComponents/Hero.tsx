...
const Hero = () => {
    ...
    return (
        <div className='pt-20 px-[2rem] sm:px-[10rem]'>
            <div className="flex flex-col items-center text-8xl dark:text-slate-100 text-slate-900 text-wrap">
                ...
                <div className="flex flex-col sm:flex-row text-2xl mt-5">
                    <button className="bg-slate-100 px-6 py-4 mr-5 dark:text-slate-900 rounded-md active:scale-95 transition-all mb-5 sm:mb-0">Get Started</button>
                    <button className="hover:bg-slate-100 px-6 py-4 mr-5 hover:dark:text-slate-900 rounded-md active:scale-95 transition-all">Get in Touch</button>
                </div>

                <div className="flex flex-col text-3xl mt-20 mb-5">
                    <p className="">Partnered with Multiple Schools In Ohio</p>
                </div>
